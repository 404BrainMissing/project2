...
<nav style="background-color: #FFEF00;" class="p-4 fixed w-full top-0 z-50">
    <div class="container mx-auto flex justify-between items-center">
        ...
        <div class="flex-grow space-x-16 hidden lg:flex" style="margin-left: 480px">
            <a href="/project2/home" class="text-primary hover:underline font-bold text-white">HOME</a>
    ...
    {#if menuOpen}
        ...
        <div class="bg-gray-800 text-white space-y-2 px-4 py-2 lg:hidden">
            <a href="/project2/home" class="block text-white hover:bg-gray-700 focus:ring-4 focus:ring-gray-500 font-semibold rounded-lg px-4 py-2 transition duration-200">Home</a>
