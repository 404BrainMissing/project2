...
<div>
    <div class="bd">
        <div>
            <h1 class="text-center text-3xl font-bold mt-6">OLONGAPO CITY EMERGENCY HOTLINES</h1>
        <Card size="none">
            <Tabs tabStyle="full" defaultClass="flex rounded-lg divide-x rtl:divide-x-reverse divide-gray-200 shadow dark:divide-gray-700">
                <TabItem class="w-full flex flex-col items-center" open>
                    <span slot="title">ALL</span>
                    
                    <div class="flex flex-wrap justify-around w-full">
                        <!-- Disaster Risk Reduction and Management Office Section -->
                        <div class="border rounded-lg p-4 m-2 w-1/4">
                ...
                <TabItem class="w-full flex flex-col items-center justify-center text-center h-full">
                    <span slot="title" class="text-lg font-semibold">Disaster Risk Reduction and Management Office</span>
                ...
                <TabItem class="w-full flex flex-col items-center justify-center text-center h-full">
                  ...
                  <span slot="title"  class="text-lg font-semibold">Barangay Contacts</span>
                ...
                <TabItem class="w-full">
                  <span slot="title">Police Stations</span>
